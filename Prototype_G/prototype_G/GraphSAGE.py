...
class NeighborAggregator(nn.Module):
    def __init__(self, input_dim, output_dim, 
        ...
        Args:
            ...
            aggr_method: Neighbour aggregation method (default: {mean})
        """
...
class SageGCN(nn.Module):
    def __init__(self, input_dim, hidden_dim,#1  1024
                 activation=F.relu,
        ...
        Args:
            ...
            hidden_dim: the dimension of the hidden feature
            ...
            aggr_hidden_method: update method for node features, ["sum", "concat"]
...
class GraphSage(nn.Module):
    def __init__(self, input_dim, hidden_dim,
        ...
        self.gcn.append(SageGCN(hidden_dim[-2], hidden_dim[-1]))
